...
export const AuctionCreateView = () => {
  ...
  return (
    <>
      <Row className="creator-base-page1" style={{paddingTop: 50,display:'flex',flexDirection:'row',alignItems:'flex-start!important',maxWidth:'1441px',margin:'auto'}}>
        {stepsVisible && (
        ...
        <Col span={17} className="main-sell-create-steps">
          {stepsByCategory[attributes.category][step][1]}
          {0 < step && stepsVisible && (
            <div style={{ margin: 'auto', width: 'fit-content' }}>
              <Button className="back-button" onClick={() => gotoNextStep(step - 1)}>Back</Button>
            </div>
          )}
        </Col>
      </Row>
        ...
        <Col className="section" xl={24}>
          <label className="action-field">
            ...
            <Input
              ...
              autoFocus
              className="input"
              style={{maxWidth:'350px',height:'62px'}}
          ...
          {props.attributes.category !== AuctionCategory.Open && (
            <label className="action-field">
              ...
              <Input
                ...
                min={0}
                autoFocus
                className="input tier-start-price"
                placeholder="Price"
                prefix="◎"
                suffix={props.attributes.quoteMintInfoExtended? props.attributes.quoteMintInfoExtended.symbol
                  : props.attributes.quoteMintAddress == WRAPPED_SOL_MINT.toBase58()? "SOL": "CUSTOM"}
...
const EndingPhaseAuction = (props: {
  ...
  return (
    <>
      ...
      <Row className="content-action">
        <Col className="section" xl={15} style={{marginLeft:'0px'}}>
          ...
          <label className="action-field">
            ...
            <Input
              type="number"
              className="input input-border input-border-percentage"
  ...
  return (
    <>
      ...
      {props.attributes.tiers.map((wcg, configIndex) => (
        <Col className="content-action" key={configIndex}>
          <Row>
          ...
          {wcg.items.map((i, itemIndex) => (
            <Col className="section Auction-ArtInfo" xl={5} key={itemIndex} style={{}}>
              <Card className="Add-Auction-Nft">
                <ArtSelector
                ...
                {(i as TierDummyEntry).winningConfigType !== undefined && (
                  <>
                    <Select
                      ...
                      style={{ width: '100%', marginTop:'20px',border: '1px solid #F5F5F5',borderRadius:'18px'}}
                      onChange={value => {
                    ...
                    {((i as TierDummyEntry).winningConfigType ===
                      ...
                      (i as TierDummyEntry).winningConfigType ===
                        WinningConfigType.PrintingV2) && (
                      <label className="action-field" style={{marginTop:'20px'}}>
                        <span className="field-title">
...
const ParticipationStep = (props: {
  ...
  return (
    <>
      ...
      <Row className="content-action">
        <Col className="section Participation-add-nft" xl={24}>
          <ArtSelector
          ...
          <label className="action-field">
            <span className="field-title" style={{marginTop:'24px'}}>Price</span>
            <span className="field-info" style={{marginTop:'8px'}}>
  ...
  return (
    <>
      ...
      <Row className="content-action">
        <Col xl={8}>
          {item?.metadata.info && (
            <ArtCard pubkey={item.metadata.pubkey} small={true} className="Review-NFT"/>
          )}
        </Col>
        <Col className="section" xl={16}>
          <Row>
            <Statistic
