...
export const ArtCreateView = () => {
  ...
  return (
    <div style={{width:'100%',background:'#f4fafe'}}>
      <Row className={'creator-base-page'} style={{ paddingTop: 50 }}>
        {/* {stepsVisible && ( */}
          ...
          <Col  style={{display:'flex'}}>
            <div style={{display:'flex', width:'150px'}}>
              <div className={step == 0 ? "stepStauteFocused" : "stepStauteFocused"}>1</div>
              <div className={step == 0 ? "stepsTitleFocused" : "stepsTitleFocused"}>Category</div>
              <div className="rightArrow">
                <img src="./img/arrow-right.png" />
              </div>
            </div>
            <div style={{display:'flex', width:'150px',marginLeft:'19.67px'}}>
              <div className={ step != 0 ? "stepStauteFocused" : "stepStaute"}>2</div>
              <div className={step != 0 ? "stepsTitleFocused" : "stepsTitle"}>Upload</div>
              <div className="rightArrow">
                <img src="./img/arrow-right.png" />
              </div>
            </div>
            <div style={{display:'flex', width:'150px',marginLeft:'19.67px'}}>
              <div className={ step != 0 && step != 1 ? "stepStauteFocused" : "stepStaute"}>3</div>
              <div className={ step != 0 && step != 1 ? "stepsTitleFocused" : "stepsTitle"}>Info</div>
              <div className="rightArrow">
                <img src="./img/arrow-right.png" />
              </div>
            </div>
            <div style={{display:'flex', width:'150px',marginLeft:'19.67px'}}>
              <div className={step != 0 && step != 1 && step != 2 ? "stepStauteFocused" : "stepStaute"}>4</div>
              <div className={step != 0 && step != 1 && step != 2 ? "stepsTitleFocused" : "stepsTitle"}>Royalities</div>
              <div className="rightArrow">
                <img src="./img/arrow-right.png" />
              </div>
            </div>
            <div style={{display:'flex', width:'150px',marginLeft:'19.67px'}}>
              <div className={step != 0 && step != 1 && step != 2 && step != 3 ? "stepStauteFocused" : "stepStaute"}>5</div>
              <div className={step != 0 && step != 1 && step != 2 && step != 3 ? "stepsTitleFocused" : "stepsTitle"}>Launch</div>
              <div className="rightArrow">
                <img src="./img/arrow-right.png" />
              </div>
            </div>
        ...
        {/* )} */}
        <Col span={24} {...(stepsVisible ? { md: 20 } : { md: 24 })} style={{marginTop:'44px', marginBottom:'112px'}} className="main-sell-create-steps">
          {step === 0 && (
            <CategoryStep
          ...
          {0 < step && step < 5 && (
            <div style={{ margin: 'auto', width: 'fit-content' }}>
              <Button className="back-button" onClick={() => gotoStep(step - 1)}>Back</Button>
            </div>
          )}
        </Col>
      </Row>
  ...
  return (
    <>
      <Row className="call-to-action">
        <h2 style={{}}>Create a new item</h2>
        <p>
          First time creating on Metaplex?{' '}
          <a href="#">Read our creators’ guide.</a>
        </p>
      </Row>
      <Row justify={width < 768 ? 'center' : 'start'} style={{justifyContent:'center'}}>
        <Col>
          <Row style={{display:'flex'}}>
            ...
            >
              <div>
                <img className="banner-img" src="./img/image 8.png" />
              </div>
              <div style={{marginLeft:'26.22px'}}>
                <img className="banner-img" src="./img/line 15.png" />
              </div>
              <div style={{marginLeft:'23.95px'}}>
                <div>Image</div>
          ...
          <Row style={{marginTop:'20px'}}>
            ...
            >
              <div>
                <img className="banner-img" src="./img/audio-square 1.png" />
              </div>
              <div style={{marginLeft:'26.22px'}}>
                <img className="banner-img" src="./img/line 15.png" />
              </div>
          ...
          <Row style={{marginTop:'20px'}}>
            ...
            >
              <div>
                <img className="banner-img" src="./img/document-code 1.png" />
              </div>
              <div style={{marginLeft:'26.22px'}}>
                <img className="banner-img" src="./img/line 15.png" />
              </div>
        ...
        <Col style={{marginLeft:'31px'}}>
          <Row>
            ...
            >
              <div>
                <img className="banner-img" src="./img/video 1.png" />
              </div>
              <div style={{marginLeft:'26.22px'}}>
                <img className="banner-img" src="./img/line 15.png" />
              </div>
          ...
          <Row style={{marginTop:'20px'}}>
            ...
            >
              <div>
                <img className="banner-img" src="./img/3d-square 1.png" />
              </div>
              <div style={{marginLeft:'26.22px'}}>
                <img className="banner-img" src="./img/line 15.png" />
              </div>
...
const InfoStep = (props: {
  ...
  return (
    <>
      ...
      <Row className="content-action" justify="space-around" style={{justifyContent:'space-between'}}>
        
        <Col className="section leftSection" style={{ minWidth: 300 }}>
...
const LaunchStep = (props: {
  ...
  return (
    <>
      ...
      <Row className="content-action" justify="space-around" style={{justifyContent:'space-between', marginTop:'52px'}}>
        
        <Col className="section" style={{ minWidth: 300,padding:'0',margin:'0' }}>
          <Statistic
