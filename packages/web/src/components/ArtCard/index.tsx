  ...
  const card = (
    ...
    >
      <Meta
        ...
        description={
          <>
           <div style={{display:'flex',padding:'13.37px 0px 15.53px 15.53px'}}>
              {/* <MetaAvatar creators={creators} size={32} /> */}
              <img src="./img/ArtOwner.png" style={{borderRadius:'50%', width:'32px', height:'32px',marginTop: '6px'}}/>
              ...
              <div className='ArtDescription'>
                <div style={{color:'#1C3BE0'}}>{`${name}`}</div>
